...
public class AdminPromptConfigServletSecurityTest {
    ...
    public void setUp() {
        ...
        configFactory = new ReviewConfigFactory();
    ...
    public void doGetDoesNotLeakExceptionMessageAndIncludesCorrelationReference() throws Exception {
        ...
        when(configService.getConfigurationAsMap()).thenThrow(new RuntimeException("apiKey=super-secret"));

        StringWriter stringWriter = new StringWriter();
        when(response.getWriter()).thenReturn(new PrintWriter(stringWriter));

        AdminPromptConfigServlet servlet = new AdminPromptConfigServlet(
                userManager,
                loginUriProvider,
                templateRenderer,
                configService,
        ...
        verify(templateRenderer).render(eq("/templates/admin-prompts.vm"), contextCaptor.capture(), any(PrintWriter.class));
        ...
        assertFalse(errorMessage.contains("apiKey=super-secret"));
