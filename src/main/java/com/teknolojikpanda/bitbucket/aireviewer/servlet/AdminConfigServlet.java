...
public class AdminConfigServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            log.error("Failed to load configuration for admin UI [{}]", correlationId, ex);
    ...
    context.put("reviewMode", configValues.getOrDefault("reviewMode", defaults.get("reviewMode")));
    context.put("reviewModeOptions", ReviewMode.descriptors());
