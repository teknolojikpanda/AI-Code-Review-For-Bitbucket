package com.teknolojikpanda.bitbucket.aireviewer.hook;
...
public class AIReviewInProgressMergeCheck implements RepositoryMergeCheck {
    ...
    public static final String MODULE_KEY = "com.teknolojikpanda.bitbucket.ai-code-reviewer:ai-reviewer-in-progress-merge-check";
